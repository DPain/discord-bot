          ...
          if (message.startsWith("-")) {
            if (message.startsWith("-remind ")) {
              ...
              try {
                ...
                scheduler.addReminder(new Reminder(castedEvent.getAuthor(),
                    castedEvent.getChannel(), param.substring(indexOfFirstSpace + 1)), hours);

                castedEvent.getChannel()
                    .sendMessage(
                        String.format("Reminder set %d hours later for: %s", hours, description))
                    .queue();
              ...
              try {
                ...
                String result = Scheduler.getTimesFromNow(Scheduler.hoursToSeconds(hours));
