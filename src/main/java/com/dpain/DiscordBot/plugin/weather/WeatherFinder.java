...
public class WeatherFinder {
  private final static Logger logger = LoggerFactory.getLogger(WeatherFinder.class);
  ...
  public WeatherDataSet getWeathersByCity(String city) {
    ...
    try {
      ...
      logger.error("City name contains a non-acceptable character!");
    } catch (JSONException e) {
      logger.error("Received data is not in a correct JSON format!");
    } catch (IOException e) {
